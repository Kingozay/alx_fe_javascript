...
function addQuote() {
  ...
  if (newQuoteText && newQuoteCategory) {
    ...
    alert("Quote added successfully!"); // Use alert for notification
    filterQuotes(); // Refresh the displayed quotes
  } else {
    alert("Please fill in both fields."); // Use alert for notification
  }
}
...
function importFromJsonFile(event) {
  ...
  fileReader.onload = function (event) {
    ...
    populateCategories(); // Update the category dropdown
    alert("Quotes imported successfully!"); // Use alert for notification
    filterQuotes(); // Refresh the displayed quotes
  };
...
async function syncQuotes() {
  try {
    ...
    // Notify the user
    alert("Quotes synced with server!"); // Use alert for notification
  } catch (error) {
    console.error("Error syncing quotes:", error);
    alert("Failed to sync quotes with server."); // Use alert for notification
  }
}
...
function resolveConflicts() {
  ...
  if (userChoice) {
    // Keep local changes
    alert("Local changes preserved."); // Use alert for notification
  } else {
